            ...
            <main className="flex flex-col flex-1 pb-20 pt-10 px-5 lg:mx-36 xl:mx-96 text-lg">
                <article className="card card-bordered space-y-5 p-5 bg-base-300">
                    ...
                    <p>
                        ...
                        expression of skill, creativity, and passion. Whether you&apos;re a craftsman looking to share
                        your
                    ...
                    <p className="pt-5">
                        Join us in celebrating craftsmanship and supporting a community of artisans. Let&apos;s bridge
                        generations and keep the spirit of handmade crafts alive.
                    </p>
                </article>
            </main>
        );
