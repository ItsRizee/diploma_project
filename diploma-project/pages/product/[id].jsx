            ...
            <main className="flex flex-col flex-1 justify-center pb-20 pt-5 space-y-20">
                <section
                    ...
                    <figure className="w-4/5 md:w-3/6 xl:w-1/3 shadow-2xl rounded-xl">
                        <Image src={product.displayImageURL} className="h-full w-full object-cover rounded-xl"
                               alt="This is the display picture" layout="responsive" width={350} height={233}/>
                    </figure>
                    <div className="flex flex-col space-y-10 w-2/3 md:w-2/6">
                        ...
                        <div
                            className="flex flex-col sm:flex-row items-center sm:justify-between space-y-10 sm:space-y-0">
                                ...
                                <Link tabIndex={0} href={`/catalog/${owner.uid}`}>
                                    <figure className="relative btn btn-ghost btn-circle avatar rounded-full">
                                        <Image src={owner.photoURL ? owner.photoURL : default_profile_picture}
                                               className="rounded-full" alt="avatar icon" width={40} height={40}/>
                                    </figure>
                                </Link>
