...
import {UpdateTheme} from "../services/user";
...
const Navbar = () => {
    ...
    const toggleTheme = () => {
        ...
        UpdateTheme(theme === 'dark' ? 'light' : 'dark').catch((error) => {
            console.log(error);
        });
    ...
    useEffect(() => {
        if (themeToggleRef.current) {
            themeToggleRef.current.checked = user.theme !== 'dark';
        }
        ...
        <nav className="navbar flex-none bg-none space-x-4 sm:px-5">
            ...
            <div className="navbar-end flex -space-x-1 sm:space-x-3">
                ...
                <button className="xl:hidden btn btn-ghost btn-circle p-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 sm:h-8 sm:w-8" fill="none"
                ...
                <div className="dropdown dropdown-end">
                    ...
                    <div
                        className="mt-3 z-[3] p-2 shadow-xl menu menu-sm dropdown-content bg-base-200 rounded-box w-52 dark:bg-gray-800">
