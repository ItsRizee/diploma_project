...
const Navbar = () => {
    ...
    return (
        <div className="navbar bg-none">
            ...
            <div className="navbar-end sm:space-x-4 flex">
                <div className="hidden xl:block form-control">
                    <input type="text" placeholder="Search" className="input input-bordered w-full" />
                </div>
                <button className="xl:hidden btn btn-ghost btn-circle">
                ...
                <div className="dropdown dropdown-end">
                    ...
                    <div className="mt-3 z-[1] p-2 shadow-xl menu menu-sm dropdown-content bg-base-200 rounded-box w-52 dark:bg-gray-800">
                        <div className="divide-y w-48 divide-gray-300 dark:divide-gray-700">
