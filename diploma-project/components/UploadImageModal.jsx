...
const UploadImageModal = () => {
    ...
    return (
        <div>
            <button className="btn btn-ghost btn-sm btn-circle absolute right-12 -bottom-1 bg-zinc-300 hover:bg-zinc-500 opacity-80 z-[2]" onClick={()=>document.getElementById('my_modal_3').showModal()}>
